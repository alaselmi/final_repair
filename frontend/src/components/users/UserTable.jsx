                ...
                <td className="px-6 py-5">
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => onEdit?.(user)}
                      className="rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200 dark:hover:bg-slate-900"
                    >
                      Edit
                    </button>
                    <button
                      ...
                      className="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-700 transition hover:bg-rose-100 dark:border-rose-700/40 dark:bg-rose-950/80 dark:text-rose-300 dark:hover:bg-rose-900"
                    >
                      Delete
                    </button>
                  </div>
